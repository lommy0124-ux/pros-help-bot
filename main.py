...
BENEFIT_TEXT = """💎 Bitunix 혜택 안내

1️⃣ Task Center → 시작 후 입금
   (해외 거래소 경유 필요)

2️⃣ 기간별 입금 이벤트 진행
   (예: 특정 기간 내 입금 시 최대 50% 추가 증정금 지급)

3️⃣ 캠페인 / Task Center 내 추가 이벤트 참여

⚠️ 이벤트 내용 및 조건은 시기별로 변경될 수 있습니다.
상세 안내는 팀방 내 ‘이벤트’ 탭을 참고해주세요.

※ Pros Team 파트너 링크로 가입한 계정만 적용됩니다.
"""
